...
class AdapterPopMovie(private val popMovieList: List<Movie>, private val genres: Genres, private val onItemClick: (Movie) -> Unit) :
    RecyclerView.Adapter<AdapterPopMovie.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_popmovie, parent, false)
        return ItemViewHolder(view)
    }

    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        val item = popMovieList[position]
    ...
    override fun getItemCount() = popMovieList.size
